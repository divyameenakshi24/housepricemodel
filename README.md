...
<html lang="en">
  ...
  <body>
        ...
        <div class="jumbotron jumbotron-fluid" style="background-color:orangered; ">
...
Thus a website is designed to train the house price model and to predict the price and is hosted in the URL http://divya.student.saveetha.in:8000/HouseModelTraining/ and http://divya.student.saveetha.in:8000/HouseModelPrediction/ HTML code is validated.